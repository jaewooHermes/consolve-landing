    ...
    <>
      ...
      <main className="article-wrap">
        ...
        <article className="article">
          ...
          {promptItems.map(([title, desc, prompt], index) => (
            <section key={title}>
              <h3>{index + 1}. {title}</h3>
              <p>{desc}</p>
