  ...
  return (
    <>
      ...
      <main className="article-wrap">
        ...
        <div className="hero" role="img" aria-label="미드저니 필름 사진 프롬프트 대표 그라데이션 이미지" />
        <article className="article">
          <p>각 프롬프트는 그대로 복사해서 사용할 수 있고, 필요하면 주인공·장소·시간대만 바꿔도 비슷한 톤의 이미지를 만들 수 있습니다. 결과를 더 안정적으로 맞추고 싶다면 마지막에 <code>--ar 4:5 --style raw --v 7 --stylize 200 --profile 1hmpcaj</code> 같은 비율과 버전 옵션을 붙여 사용하세요.</p>
          ...
          <table className="options"><tbody>
            ...
            <tr><td>인스타 피드 세로 이미지</td><td><code>--ar 4:5 --style raw --v 7 --stylize 200 --profile 1hmpcaj</code></td></tr>
            <tr><td>스토리/릴스 커버</td><td><code>--ar 4:5 --style raw --v 7 --stylize 200 --profile 1hmpcaj</code></td></tr>
            <tr><td>영화 스틸 느낌</td><td><code>--ar 4:5 --style raw --v 7 --stylize 200 --profile 1hmpcaj</code></td></tr>
