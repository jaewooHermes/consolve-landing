...
assert(widget.includes('conversationId'), 'widget should keep a stable quote conversation id');
assert(widget.includes('conversationMessages'), 'widget should keep ordered chat messages');
assert(widget.includes('quote-transcript'), 'widget should render the ordered chat transcript above the input');
assert(widget.includes('quote-message-user'), 'widget should render user bubbles');
assert(widget.includes('quote-message-assistant'), 'widget should render AI bubbles');
